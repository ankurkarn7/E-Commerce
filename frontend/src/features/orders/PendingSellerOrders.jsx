  ...
  return (
    <div>
      <div className='sticky top-[57px] w-full flex flex-wrap gap-3 justify-between items-center px-6 py-4 z-10 bg-white/80 backdrop-blur-md border-b border-slate-200 shadow-sm'>
            <h1 className='font-extrabold text-2xl text-slate-800'>Pending Orders</h1>
            <MenuBox />
        </div>
         <div className='max-w-6xl mx-auto p-6'>
            {loading ? (
                ...
                <p className='text-slate-500 text-xl mt-20 flex justify-center'>No pending orders.</p>
            )
        }
      </div>
...
export default PendingSellerOrders
